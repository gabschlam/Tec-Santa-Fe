...
// ModelView Matrix: where the square is positioned in the 3D coordinate system relative to the camera
...
function createSquare(gl) 
{
    ...
    srcData = This is a new data type introduced into web browsers for use with WebGL. Type: Float32Array. Also known as a typed array. This is a JavaScript type that stores compact binary data. 
...
function createSphere(gl, radius, startCircle, endCircle)
{
    var vertexBuffer;
    vertexBuffer = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, vertexBuffer);
