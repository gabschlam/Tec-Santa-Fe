...
/**
 * Tomado de Android 6 for Programmers, 3rd Edition By: Alexander Wald, Harvey Deitel, Paul Deitel
 * Recordemos que una clase csf.itesm.objetosvolley.Singleton se implementa un patrÃ³n Ãºnico. En ingenierÃ­a de software,
 * el patrÃ³n singleton (instancia Ãºnica en inglÃ©s) es un patrÃ³n de diseÃ±o diseÃ±ado para restringir la
 * creaciÃ³n de objetos pertenecientes a una clase o el valor de un tipo a un Ãºnico objeto.
 */
public class Singleton {
    ...
    /**
     *  hemos creado una instancia csf.itesm.objetosvolley.Singleton con el constructor privado para poder utilizarlo
     *  internamente
     */
    private Singleton(Context context) {
         ...
         * En el metodo RequestQueue verificamos si el objeto ya existe, si no, usamos el metodo
    ...
    /**
     * Este metodo toma un tipo genÃ©rico y lo aÃ±ade a la cola de solicitudes. En el constructor,
    ...
    /**
     * Este metodo se utiliza para cancelar una solicitud utilizando una etiqueta.
     */
