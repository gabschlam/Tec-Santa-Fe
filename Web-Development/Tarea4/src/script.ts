...
var row = document.getElementsByClassName('Cell') as HTMLCollectionOf<HTMLElement>
var index:number = 0

// Function for sorting data by email, for display
function sortByEmail(a:any, b:any) {
    a = a[3]
    b = b[3]
...
function getData() {
    ...
    for (let i = 0; i < data_sort.length; i++) {
        ...
        var fieldImg = document.getElementById(imageID) as HTMLImageElement
...
function binarySearch(value:string, array:string[][], posEmail:number) {
    let start:number = 0
...
function convertToMorseCode(){
    ...
    var morseAlphabet = [ ".-","-...","-.-.","-..",".","..-.","--.","....","..",".---","-.-",".-..","--","-.","---",".--.","--.-",".-.","...","_","..-","...-",".--","-..-","-.--","--..",".----","..---","...--","....-",".....","-....","--...","---..","----.","-----"];
    var textToConvert = (document.getElementById("text") as HTMLInputElement).value;
    // Time between each digit, from html
    var time_digit = (document.getElementById("t_digit") as HTMLInputElement).value;
    // Time between each character, from html
    var time_character = (document.getElementById("t_character") as HTMLInputElement).value;
    // Time between each word, from html
    var time_word = (document.getElementById("t_word") as HTMLInputElement).value;
    var morseText = "";
    ...
    var time:number // Time for each promise
